...
<form action="admin_stock_update_proc.jsp" method="post">
    ...
    <label>입고일</label>
    <input type="text" name="release_date" value="<%= stockDto.getRelease_date().toString().substring(0,10) %>" readonly />

    <label>최근 수정일</label>
    <input type="text" name="create_date" value="<%= stockDto.getCreate_date().toString().substring(0,10) %>" readonly />
